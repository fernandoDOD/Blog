...
class DefaultController extends Controller
{
	...
	public function actionIndex()
	{
		...
		if (!Yii::app()->user->isGuest){
			$frase1 = GeneralValue::model()->findByPk(1);
			$frase2 = GeneralValue::model()->findByPk(2);
