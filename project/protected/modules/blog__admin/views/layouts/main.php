...
<html>
    ...
    <div class="md-modal md-just-me" id="logout-modal">
        <div class="md-content">
            ...
            <div>
                <p class="text-center">¿Seguro quieres salir del sistema de administracion del blog?</p>
                <p class="text-center">
                <button class="btn btn-danger md-close">No!</button>
                <a href="<?php echo Yii::app()->createUrl('blog__admin/logout') ?>" class="btn btn-success md-close">Si, quiero salir</a>
                </p>
            </div>
        </div>
    </div>        <!-- Modal End -->
